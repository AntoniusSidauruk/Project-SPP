...
if ($date >= 18){
  $season = "Good Evening";
}elseif ($date <= 17 && $date >= 12) {
  $season = "Good Afternoon";
}else{
  $season = "Good Morning";
}
  ...
  <div class="navbar-menu-wrapper d-flex align-items-top"> 
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text"><?php echo $season; ?>, <span class="text-black fw-bold"><?php echo ucwords($_SESSION['fullname']) ?></span></h1>
        <h3 class="welcome-sub-text"> melakukan rekap transaksi pembayaran SPP </h3>
      </li>
    </ul>
